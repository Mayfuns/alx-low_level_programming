 ...
 * @e_ident: This is  pointer to an array with the ELF magic numbers.
 *
 ...
 * @e_ident:This pointer to an array contains the ELF class.
 */
void print_class(unsigned char *e_ident)
{
	printf("  Class:                             ");
 ...
 * @e_ident: This pointer to an array contains the ELF version.
 */
void print_version(unsigned char *e_ident)
{
	printf("  Version:                           %d",
...
/**
 * print_type - This prints the type of an ELF header's entry point.
 * @e_type: This denotes the ELF type.
...
/**
 * print_entry - This prints an ELF header's entry point.
 ...
 * @elf: This denotes the file descriptor of the ELF file.
 *
 ...
 * @argc: This denotes the number of arguments supplied to the program.
