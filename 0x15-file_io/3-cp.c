 ...
 * @file: This denotes the name of the file buffer is storing chars for.
 *
 * Return: This denotes a pointer to the newly-allocated buffer.
 */
char *create_buffer(char *file)
{
	char *buffer;
...
/**
 * close_file - This is to close descriptors of the file.
 ...
 *              If file_from doesn't exist or can't be read- exit with code 98.
